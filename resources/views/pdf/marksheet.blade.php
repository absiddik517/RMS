    ...
    <div class="result-sheet">
        ...
        <table class="student-info">
            <tr>
                ...
                <td style="width: 33.33%; text-align:center;">শ্রেণি: <strong> {{ $student['class'] }}</strong></td>
                <td style="width: 33.33%; text-align: right;">রোল নং: <strong>{{ $student['roll'] }}</strong></td>
            </tr>
        </table>
            ...
            <tbody>
              @foreach($subjects as $name => $subject)
                ...
                <tr>
                    ...
                    <td>{{ $result['total_full_mark'] }}</td>
                    <td colspan="{{ count($theads) + 1 }}"
                    style="text-align:right">{{ $result['total_marks'] }}</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="grade-summary">
            <tr>
                ...
                round($result['point'], 2) }}</td>
                <td style="text-align:right; width: 33.33%">শতকরা: {{
                round($result['percent'], 0) }}%</td>
            </tr>
        </table>
        <div class="comment">
