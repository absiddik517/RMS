        ...
        <Card varient="gray" body-class="p-0">
          ...
          <div class="row p-2 gy-2">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
              ...
              <Dropdown animate stay header="Filter" id="filterclassDropdown">
                <template #btn>
          ...
          <div class="table-responsive">
            <table class="table table-hover y-middle text-nowrap">
              ...
              <tbody>
                <tr v-for="(item, index) in classes.data">
                  <td v-show="columns.id">{{ item.id }}</td>
                  <td v-show="columns.name">{{ item.name }}</td>
                  <td v-show="columns.short_name">{{ item.short_name }}</td>
          ...
          >
            ...
            <div class="item row">
              ...
              <Input
                ...
                :field="'subjects.' + index + '.short_name'"
                label="Short Name"
                :form="form"
                group-class="col-6"
              />
